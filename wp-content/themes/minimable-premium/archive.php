...
<section class="section-page" id="blog">
	<div class="container">
		<?php if ( is_day() ) : ?>
		<h2 class="section-title <?php if (get_option('fw_remove_sidebar')) {?>center <?php } ?>">Archive: <?php echo  get_the_date( 'D M Y' ); ?></h2>							
		<?php elseif ( is_month() ) : ?>
		<h2 class="section-title <?php if (get_option('fw_remove_sidebar')) {?>center <?php } ?>">Archive: <?php echo  get_the_date( 'M Y' ); ?></h2>	
		<?php elseif ( is_year() ) : ?>
		<h2 class="section-title <?php if (get_option('fw_remove_sidebar')) {?>center <?php } ?>">Archive: <?php echo  get_the_date( 'Y' ); ?></h2>								
		<?php else : ?>
		<h2 class="section-title <?php if (get_option('fw_remove_sidebar')) {?>center <?php } ?>">Archive</h2>	
		<?php endif; ?>
		<div class="row">
		<?php if ( have_posts() ): ?>
