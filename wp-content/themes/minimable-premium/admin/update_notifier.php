...
function update_notifier() {
	...
	<div class="wrap">
        ...
        <div id="instructions" style="max-width: 800px;">
            ...
            <p><strong>Please note:</strong> make a <strong>backup</strong> of the Theme inside your WordPress installation folder <strong>/wp-content/themes/<?php echo strtolower($theme_name); ?>-20/</strong></p>
            <p>To update the Theme, download it from your page account.</p>
            <p>Extract the zip's contents, look for the extracted theme folder, and after you have all the new files upload them using FTP to the <strong>/wp-content/themes/<?php echo strtolower($theme_name); ?>-20/</strong> folder overwriting the old ones (this is why it's important to backup any changes you've made to the theme files).</p>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://minimable.fedeweb.net/notifier-premium.xml';
